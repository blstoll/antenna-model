...
|---|---|---|---|---|
| ECEF | Earth-Centered Earth-Fixed, meters | Earth's center of mass | X: equator ∩ prime meridian; Y: equator at 90°E; Z: North pole; right-handed | `Position3D` with `coordinate_system: ecef` (required, never inferred); `geodetic_to_ecef`/`ecef_to_geodetic` (`antenna-core/src/model/coordinates_3d.rs:169,197`) |

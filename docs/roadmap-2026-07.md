...
| P3 | Ray-trace stub for feed offsets > 0.5·f | Implement (F2) / reject requests / document + flag | Document + flag on all endpoints — **adopted as-is 2026-07-16**: warning verified on all four compute endpoints, boundary documented in domain-contract + openapi; real ray tracing stays gated as F2; rejection ruled out (warn-don't-refuse, grid totality). See unit P3. | **Decided** | Maintainer, 2026-07-16 |

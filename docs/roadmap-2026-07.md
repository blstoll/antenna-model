...
- **The calibration pipeline's accuracy claims are now verified end-to-end, with caveats**
  ...
  real data) and D14 (real-anchored full-mode artifact, still open); the known-answer-recovery
